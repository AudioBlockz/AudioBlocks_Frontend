...
//         <h1
//           className={`${inter.className} capitalize`}
//           style={{
//             fontSize: "48px",
//             fontWeight: 600,
//             lineHeight: "100%",
...
//           }}
//         >
//           Trending  <span className='text-gray-600'>NFT</span> Collections
//         </h1>
...
//             className="text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent border border-[#313533]"
//             style={{
//               width: "320px",
//               height: "44px",
//               borderRadius: "100px",
...
const MusicCard = ({ item }: { item: any }) => (
  ...
  >
    ...
    <div className="mt-3 flex flex-col justify-between" style={{ height: "calc(100% - 176px - 12px)" }}>
      <div>
      ...
      <div className="flex items-center justify-between mt-auto">
        <button
          className="border-gray-600 border text-white px-4 py-2 rounded-2xl transition-colors text-sm mb-2"
        >
          Buy Now
        </button>
